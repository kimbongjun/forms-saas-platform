        ...
        return (
          ...
          >
            ...
            <Link
              ...
              target="_blank"
              onClick={(e) => e.stopPropagation()}
              className="shrink-0 rounded-lg p-1.5 text-gray-300 transition-colors hover:bg-blue-50 hover:text-blue-500"
              title="폼 보기"
            >
            ...
            <button
              type="button"
              onClick={(e) => { e.preventDefault(); handleDeleteOne(project.id, project.title) }}
