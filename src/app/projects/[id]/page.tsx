...
import { CalendarRange, DollarSign, ExternalLink, SquarePen, Users } from 'lucide-react'
    ...
    <div className="space-y-5">
      ...
      <section className="rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 border-t border-gray-100 pt-5 sm:grid-cols-4">
          {[
            { label: 'Form Fields', value: fieldCount ?? 0 },
            { label: 'Responses', value: submissionCount ?? 0 },
            { label: 'Team', value: members?.length ?? 0 },
          ].map((stat) => (
      ...
      <section className="rounded-[28px] border border-gray-200 bg-white p-6 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-gray-900">팀 구성</h2>
