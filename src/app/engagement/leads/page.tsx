...
export default function EngagementLeadsPage() {
  return (
    <WorkspacePage
      ...
      title="통합 리드 DB"
      description="프로젝트 단위로 흩어져 있는 응답 데이터를 장기적으로 통합 관리하는 영역입니다. 현재 IA에서는 폼별 신청 현황 이후의 허브로 자리를 잡아 두었습니다."
      actions={[
    ...
    >
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-gray-500">각 폼의 신청 현황 데이터를 장기 관리 대상 리드로 승격하는 중간 허브로 설계했습니다.</p>
        </div>
